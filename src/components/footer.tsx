const Footer = () => {
  return (
    ...
    //       <div className="text-emerald-500 dark:text-emerald-500">
    //         <svg
    //           className="h-8"
    //           viewBox="0 0 28 24"
    //           fill="none"
    ...
    //               <button className="mt-1 w-full bg-emerald-500 px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-emerald-500 sm:mt-0 sm:w-auto sm:shrink-0">
    //                 Sign Up
    //               </button>
    //             </div>
    //           </form>
